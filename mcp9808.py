#
# modified version of https://github.com/kfricke/micropython-mcp9808 to work with phpython
#
...
class MCP9808(object):
    ...
    def __init__(self, i2c=None, addr=0x18):
        ...
        # Accept phpython.I2C wrapper or raw machine.I2C
        self._i2c = i2c._bus if hasattr(i2c, '_bus') else i2c
        self._addr = addr
        self._check_device()
